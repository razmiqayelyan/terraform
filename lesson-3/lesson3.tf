...
# CREATE STATIC IP AND ASSOCIATE IT WITH INSTANCE
...
resource "aws_instance" "my_webserver" {
  ...
  lifecycle {
  # CREATE NEW INSTANCE BEFORE TERMINATING OLD ONE, HELPS DECREASE DOWNTIME
  #  create_before_destroy = true

  # IGNORE CHANGES PREVENTING SERVER TERMINATE/RESTART
  # ignore_changes = [ "ami", "user_data" ]

  # PREVENT ALL CHANGES TO NOT BE ABLE BE APPLIED AND NOT ABLE TO TERMINATE/RESTART SERVER
